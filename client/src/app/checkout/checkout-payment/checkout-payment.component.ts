...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    ...
    this.stripe = Stripe('pk_test_51IRverDBOM1GPB58vZFVMY0G1AHqpeFbOxPJrvPaeiYtZm3qSZ8xBK9msRIWaZt2dhFxFvDpmqXnTQdwbhQJIMuR00BudNOgvt');
  ...
  submitOrder(){
    ...
    this.checkoutService.createOrder(orderToCreate).subscribe(order =>{
      ...
      this.stripe.confirmCardPayment(basket.clientSecret, {payment_method :{
